...
def test_json_repair_flow(client, monkeypatch, settings):
    User.objects.create_user("cat", password="pass12345")
        ...
        def generate_content(self, prompt):
            ...
            if FakeModel.calls == 1:
                ...
                return FakeResp(
                    ...
                    '"red_flags":[],"differential":[],"rationale":"Repaired"}'
                )
...
def test_transient_error_backoff(client, monkeypatch, settings):
    User.objects.create_user("dog", password="pass12345")
    ...
    class FlakyModel:
        ...
        def generate_content(self, prompt):
            ...
            return FakeResp(
                '{"severity":"Severe","summary":"Y","advice":"See doctor",'
                '"red_flags":[],"differential":[],"rationale":"ok"}'
            )
