...
class AppointmentEditForm(forms.Form):
    """Form for editing an existing appointment (for patients)."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        if appointment:
            ...
            self.fields["appointment_date"].initial = appointment.appointment_date
            self.fields["appointment_time"].initial = appointment.appointment_time
            self.fields["appointment_type"].initial = appointment.appointment_type
