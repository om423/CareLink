...
class PatientProfile(models.Model):
    ...
    age = models.PositiveIntegerField(
        null=True, blank=True, help_text="Patient's age in years"
    )
    ...
    medical_history = models.TextField(
        blank=True,
        help_text="Previous medical conditions and history"
    )
    allergies = models.TextField(
        blank=True,
        help_text="Known allergies (medications, foods, environmental)"
    )
